...
1.问题意识（consciousness of issue）：始终从“问题本身出发”，而不是从学派、权威、意识形态出发。定义批评和策展叙事的焦点（方法论、逻辑、结构、理论假设的问题）。保证策展有目标性和逻辑性。

2.发言位置（positionality）：明确自己的位置和视角——不仅是学术身份，更是历史/文化身份。让批评和策展有立场透明性，别人知道你是谁，从哪里看问题，以此避免被解读为意识形态攻击或盲目否定。
